...
public class ReceiptControllerMethods {
    @Test
    public String testCreateReceiptAPI(String businessOwnerToken,Integer tenantId1,String propertyAddress, Integer saleItemId1) throws JsonProcessingException {
        // Prepare the request body
        Map<String, Object> requestBody = new HashMap<>();
        requestBody.put("tenant_id", tenantId1);
        requestBody.put("tenant_name", "tenant_name");
        requestBody.put("property_address", propertyAddress);
        ...
        saleItem1.put("sale_id", saleItemId1);
