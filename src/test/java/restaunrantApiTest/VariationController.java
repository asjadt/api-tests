...
public class VariationController {
    ...
    public String testStoreVariationTypeAPI(String restaurantOwnerToken,Integer restaurantId) throws JsonProcessingException {
        // Prepare the request body
        Map<String, Object> requestBody = new HashMap<>();
        requestBody.put("name", "test");
        requestBody.put("description", "test");
    ...
    public String testStoreMultipleVariationTypeAPI(String restaurantOwnerToken,Integer restaurantId) throws JsonProcessingException {
        // Set the restaurant ID
...
return response;
    ...
    @Test
    public void testUpdateMultipleVariationTypeAPI(String restaurantOwnerToken,Integer variationTyeId) throws JsonProcessingException {
        // Prepare the request body
        List<Map<String, String>> variationTypes = new ArrayList<>();

        Map<String, String> variationType1 = new HashMap<>();
        variationType1.put("varation_type_id", variationTyeId.toString());
        variationType1.put("name", "Multiple");
        variationType1.put("description", "Multiple");
        variationTypes.add(variationType1);
...
//        variationTypes.add(variationType2);
    ...
    @Test
    public void testUpdateMultipleVariationAPI(String restaurantOwnerToken,Integer variationId) throws JsonProcessingException {
        // Prepare the request body
        List<Map<String, String>> variations = new ArrayList<>();

        Map<String, String> variation1 = new HashMap<>();
        variation1.put("id", variationId.toString());
        variation1.put("name", ("Multiple" + Math.random()));
        variation1.put("description", "Multiple");
        variation1.put("price", "10");
        variations.add(variation1);
...
//        variations.add(variation2);
    ...
    @Test
    public void testUpdateVariationTypeAPI(String restaurantOwnerToken,Integer variationTypeId) throws JsonProcessingException {
        // Prepare the request body
        Map<String, Object> requestBody = new HashMap<>();
        requestBody.put("name", "test");
        requestBody.put("description", "test");
        requestBody.put("VTypeId", variationTypeId);
    ...
    public String testStoreVariationAPI(String restaurantOwnerToken,Integer variationTypeId) throws JsonProcessingException {
        // Prepare the request body
        Map<String, Object> requestBody = new HashMap<>();
        requestBody.put("name", "test");
        requestBody.put("description", "test");
        requestBody.put("type_id", variationTypeId);
    ...
    public String testStoreMultipleVariationAPI(String restaurantOwnerToken,Integer restaurntId,Integer variationTypeId) throws JsonProcessingException {
        // Prepare the request body
        Map<String, Object> requestBody = new HashMap<>();
        requestBody.put("restaurant_id", restaurntId);
        ...
        variation1.put("name", "ssssss");
        variation1.put("description", "Multiple");
        variation1.put("type_id", variationTypeId);
        variation1.put("price", 90);
        variations.add(variation1);
...
//        variations.add(variation2);
    ...
    @Test
    public void testUpdateVariationAPI(String restaurantOwnerToken,Integer variationId) throws JsonProcessingException {
        // Prepare the request body
        Map<String, Object> requestBody = new HashMap<>();
        requestBody.put("name", "test");
        requestBody.put("description", "test");
        requestBody.put("Vid", variationId);
    ...
    public String testStoreDishVariationAPI(String restaurantOwnerToken,Integer variationTypeId,Integer dishId ) throws JsonProcessingException {
        // Prepare the request body
        Map<String, Object> requestBody = new HashMap<>();
        requestBody.put("minimum_variation_required", 1);
        requestBody.put("no_of_varation_allowed", 1);
        requestBody.put("type_id", variationTypeId);
        requestBody.put("dish_id", dishId);
    ...
    public String testStoreMultipleDishVariationAPI(String restaurantOwnerToken,Integer variationTypeId,Integer dishId) throws JsonProcessingException {
...
//        variations.add(variation2);
        ...
        String response = given()
                ...
                .body(requestBodyJson)
                .when()
                .post(URL + "/api/variation/multiple/dish_variation/" + dishId)
                .then()
                .statusCode(201)
                .extract()
                .response()
    ...
    @Test
    public void testGetAllDishVariationAPI(String restaurantOwnerToken,Integer dishId) throws JsonProcessingException {
        String response = given()
                .contentType(ContentType.JSON)
                .accept(ContentType.JSON)
                .header("Authorization", "Bearer " + restaurantOwnerToken) // Set the authorization header
                .when()
                .get(URL + "/api/variation/dish_variation/" + dishId)
                .then()
                .statusCode(201)
                .extract()
                .response()
    ...
    @Test
    public void testUpdateDishVariationAPI(String restaurantOwnerToken,Integer typeId,Integer dishId) throws JsonProcessingException {
    ...
    @Test
    public void testUpdateMultipleDishVariationAPI(String restaurantOwnerToken,Integer variationTypeId,Integer dishId) throws JsonProcessingException {


        // Create the request body JSON
        String requestBody = "{ \"DishVariations\": [ { \"minimum_variation_required\": 10, \"no_of_varation_allowed\": 10, \"type_id\": " +variationTypeId +", \"dish_id\": "+dishId+" } ] }";
    ...
    @Test
    public void testGetAllVariationWithDishAPI(String restaurantOwnerToken,Integer restaurantId) throws JsonProcessingException {
    ...
    @Test
    public void testGetSingleVariationTypeAPI(String restaurantOwnerToken,Integer variationTypeId) throws JsonProcessingException {
        ...
        String response = given()
                ...
                .header("Authorization", "Bearer " + restaurantOwnerToken) // Set the authorization header
                .when()
                .get(URL + "/api/variation-type/" + variationTypeId)
                .then()
                .statusCode(201)
                .extract()
                .response()
    ...
    @Test
    public void testGetAllVariationTypeWithVariationAPI() throws JsonProcessingException {
        int restaurantId = 1;
    ...
    @Test
    public void testGetAllVariationTypeWithVariationAPI(String restaurantOwnerToken,Integer restaurantId) throws JsonProcessingException {
    ...
    @Test
    public void testGetAllVariationByTypeIdAPI(String restaurantOwnerToken, Integer typeId) throws JsonProcessingException {
    ...
    @Test
    public void testGetAllVariationByRestaurantIdAPI(String restaurantOwnerToken,Integer restaurantId) throws JsonProcessingException {
    ...
    @Test
    public void testDeleteDishVariationAPI(String restaurantOwnerToken,Integer typeId,Integer dishId) throws JsonProcessingException {
    ...
    @Test
    public void testDeleteVariationTypeAPI(String restaurantOwnerToken,Integer variationTypeId) throws JsonProcessingException {
